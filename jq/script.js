...
var embell = {
    ...
    outer_wall: [
        ...
        'Yes, I am a guard of the wall. But I need a wall to guard, kapish?',
...
var items = [
    ...
    [19, 'Golden Hen', 'Gives back all spent coins', 'darkgoldenrod', 'instant item'],
    ...
    [23, 'Minting Machine', 'Hammer mints coins up to 4 at a slow rate', 'orchid', 'equippable item'],
...
function calc(dt) {
    ...
    if (tower1.discontent.drinking == 1) {
        ...
        if (tower1.discontent.riot == 0) { tower1.discontent.is[tower1.discontent.selected_unit] += dt; } else if (tower1.discontent.riot == 1) { tower1.discontent.frame += dt; }
    ...
    if (messenger.active == 1) {
        ...
        if (messenger.isRunning == 1) {
            ...
            if (messenger.timeStay <= 10) {
                messenger.opacity -= 0.1 * dt;
...
function updateCounter() {
    ...
    if (player.system_frame % 2 == 0) {
        ...
        if (winecellar.drunk[0] > 1) {
            ...
            if (alchemist.purse.items[1] == 0 && (winecellar.duration - winecellar.wine_frame) > wineDurationCalc()) { weaklings_drink_button.css('color', 'var(--blue)'); } else if (alchemist.purse.items[0] == 4) {
            ...
            if (alchemist.purse.items[1] == 0 && (winecellar.duration - winecellar.wine_frame) > wineDurationCalc()) { dwarves_drink_button.css('color', 'var(--blue)'); } else if (alchemist.purse.items[0] == 4) {
            ...
            if (alchemist.purse.items[1] == 0 && (winecellar.duration - winecellar.wine_frame) > wineDurationCalc()) { humans_drink_button.css('color', 'var(--blue)'); } else if (alchemist.purse.items[0] == 4) {
            ...
            if (alchemist.purse.items[1] == 0 && (winecellar.duration - winecellar.wine_frame) > wineDurationCalc()) { ogres_drink_button.css('color', 'var(--blue)'); } else if (alchemist.purse.items[0] == 4) {
        ...
        if (prestige.quests_flag == 1) {
            ...
            if (tower2.wizards == 66) {
                if (prestige.quests[0] < 666) {
                    quest1_label.text(Math.floor(prestige.quests[0]) + '/666').css('color', 'var(--main_color');
                } else { quest1_label.text('666/666').css('color', 'var(--gray)'); }
            }
            if (tower2.warlocks == 66) {
                if (prestige.quests[1] < 666) {
                    quest2_label.text(Math.floor(prestige.quests[1]) + '/666').css('color', 'var(--main_color');
                } else { quest2_label.text('666/666').css('color', 'var(--gray)'); }
            }
            if (tower2.witches == 66) {
                if (prestige.quests[2] < 666) {
                    quest3_label.text(Math.floor(prestige.quests[2]) + '/666').css('color', 'var(--main_color');
                } else { quest3_label.text('666/666').css('color', 'var(--gray)'); }
            }
            if (tower2.wyverns == 66) {
                if (prestige.quests[3] < 666) {
                    quest4_label.text(Math.floor(prestige.quests[3]) + '/666').css('color', 'var(--main_color');
    ...
    if (prestige.graveyard == 1) {
        ...
        if (graveyard.artifact_pointer == 0) { da1_block.html('Doomed Artifact I<br><span class="tiny">Target: ' + numT(graveyard.artifacts_target) + '</span><br><span class="small_red">' + numT(graveyard.artifacts[0]) + '</span>'); } else if (graveyard.artifact_pointer == 1) { da2_block.html('Doomed Artifact II<br><span class="tiny">Target: ' + numT(graveyard.artifacts_target) + '</span><br><span class="small_red">' + numT(graveyard.artifacts[1]) + '</span>'); } else if (graveyard.artifact_pointer == 2) { da3_block.html('Doomed Artifact III<br><span class="tiny">Target: ' + numT(graveyard.artifacts_target) + '</span><br><span class="small_red">' + numT(graveyard.artifacts[2]) + '</span>'); } else if (graveyard.artifact_pointer == 3) { da4_block.html('Doomed Artifact IV<br><span class="tiny">Target: ' + numT(graveyard.artifacts_target) + '</span><br><span class="small_red">' + numT(graveyard.artifacts[3]) + '</span>'); }
...
function buyRecalc(creature = 0) {
    ...
    if (alchemist.purse.items[1] == 0) { winecellar.duration = 900 * alchemist.purse.potion_stack + wineDurationCalc(); } else {
...
function rateCalc() {
    ...
    if (alchemist.purse.items[0] == 12 && tower0.blacksmiths >= 10) { tower1.weaklings_temp += 90; } else if (alchemist.purse.items[0] == 13 && tower0.blacksmiths >= 10) { tower1.dwarves_temp += 90; } else if (alchemist.purse.items[0] == 41 && tower0.blacksmiths >= 10) { tower1.dwarves_temp += 90; } else if (alchemist.purse.items[0] == 48 && tower0.blacksmiths >= 10) { tower1.dwarves_temp += 180; } else if (alchemist.purse.items[0] == 14 && tower0.blacksmiths >= 10) { tower1.humans_temp += 90; } else if (alchemist.purse.items[0] == 15 && tower0.blacksmiths >= 10) { tower1.ogres_temp += 90; } else if (alchemist.purse.items[0] == 25 && tower0.blacksmiths >= 10) {
        tower1.weaklings_temp += 100;
        tower1.dwarves_temp += 100;
        tower1.humans_temp += 100;
        tower1.ogres_temp += 100;
    }
    ...
    if (prestige.aviary.completed == 0) { aviary_array = alchemist.aviary.display; } else { aviary_array = prestige.aviary.display; }
...
function alchemistUI() {
    ...
    all_alchemist_upgrades.mouseenter(function() {
        alchemistInspect($(this));
    }).mouseleave(function() {
        alchemist_tooltip.hide();
        alchemist_tooltip.text('');
    });
    all_alchemist_upgrades_disabled.mouseenter(function() {
        alchemistInspect($(this));
    }).mouseleave(function() {
        alchemist_tooltip.hide();
        alchemist_tooltip.text('');
    ...
    //items
    if (prestige.alchemist_purse == 0) { items_block.hide(); } else {
        ...
        if (prestige.alchemy_lock == 0) { items_lock.hide(); } else {
            ...
            if (alchemist.purse.lock == 0) { items_lock.css('border-color', 'var(--gray)'); } else { items_lock.css('border-color', 'var(--gandlor4_dark)'); }
...
function fortificationState() {
    ...
    if (funds >= prestige.garden.fort_prices[0] && prestige.garden.fortifications[0] < 9) { fort_button_weaklings.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_weaklings.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[1] && prestige.garden.fortifications[1] < 9) { fort_button_dwarves.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_dwarves.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[2] && prestige.garden.fortifications[2] < 9) { fort_button_humans.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_humans.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[3] && prestige.garden.fortifications[3] < 9) { fort_button_ogres.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_ogres.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[4] && prestige.garden.fortifications[4] < 9) { fort_button_wizards.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_wizards.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[5] && prestige.garden.fortifications[5] < 9) { fort_button_warlocks.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_warlocks.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[6] && prestige.garden.fortifications[6] < 9) { fort_button_witches.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_witches.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[7] && prestige.garden.fortifications[7] < 9) { fort_button_wyverns.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_wyverns.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[8] && prestige.garden.fortifications[8] < 9) { fort_button_catapults.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_catapults.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[9] && prestige.garden.fortifications[9] < 9) { fort_button_crossbows.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_crossbows.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[10] && prestige.garden.fortifications[10] < 9) { fort_button_cheiroballistras.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_cheiroballistras.removeClass('fort_button').addClass('fort_button_disabled'); }

    if (funds >= prestige.garden.fort_prices[11] && prestige.garden.fortifications[11] < 9) { fort_button_cannibals.removeClass('fort_button_disabled').addClass('fort_button'); } else { fort_button_cannibals.removeClass('fort_button').addClass('fort_button_disabled'); }
...
function refreshUI() {
    ...
    if (guideAlertCheck() == true) { button_guide.attr("class", "system_alert"); } else { button_guide.attr("class", "system"); }
    ...
    if (misc_settings.settings_toggle == 0) {
        ...
        if (misc_settings.save_del_confirm_toggle == 0) { save_del_confirm_block.hide(); } else { save_del_confirm_block.show(); }
        ...
        if (prestige.messenger_alert == 0) { audio_messenger_block.hide(); } else {
    ...
    if (prestige.library.library_switch == 0) {
        reincarnation_options_block.hide();
        showFortress();
        showCounter();
    } else {
    ...
    if (prestige.temple.unlocked == 0) { temple_block.hide(); } else {
        temple_block.show();
    }
    ...
    if (medallions.vlist.length > 0) {
        ...
        for (const [key, value] of Object.entries(medallions.list)) {
            if (key == 168) { continue; }
            if (medallions.vlist[key] == 2) { medallions_label.append('<span class="block_achievement2">' + value + '</span>'); } else { medallions_label.append('<span class="block_achievement1">' + value + '</span>'); }
    ...
    //quests
    if (prestige.quests_flag == 0) { quests_block.hide(); } else {
        quests_block.show();
    ...
    if ((tower1.dwarves + tower1.dwarves_temp) < 13) {
        ...
        if (alchemist.purse.items[0] == 4) { winecellar_title.text('Barelled Water'); } else { winecellar_title.text(winecellar.name); }
    ...
    if (tower2.wyverns < 10) {
        ...
        if (prestige.cannibals == 0) { cannibals_button.hide(); } else {
        ...
        if (prestige.garden.trees <= 0) { tower3_fortifications.hide(); } else {
            tower3_fortifications.show();

            if (prestige.cannibals == 0) { fort_button_cannibals.hide(); } else { fort_button_cannibals.show(); }
        }
    ...
    if ((tower1.ogres + tower1.ogres_temp) < 10) {
        ...
        if (prestige.garden.trees <= 0) { tower2_fortifications.hide(); } else { tower2_fortifications.show(); }
    ...
    if (tower0.blacksmiths < 10) {
        ...
        if (prestige.garden.trees <= 0) { tower1_fortifications.hide(); } else { tower1_fortifications.show(); }
        ...
        if (prestige.champs.unlocked[0] + prestige.champs.unlocked[1] + prestige.champs.unlocked[2] + prestige.champs.unlocked[3] == 0) { champs_block.hide(); } else {

            champs_block.show();

            if (prestige.champs.unlocked[0] == 0) { champ_weaklings_button.hide(); } else { champ_weaklings_button.show(); }

            if (prestige.champs.unlocked[1] == 0) { champ_dwarves_button.hide(); } else { champ_dwarves_button.show(); }

            if (prestige.champs.unlocked[2] == 0) { champ_humans_button.hide(); } else { champ_humans_button.show(); }

            if (prestige.champs.unlocked[3] == 0) { champ_ogres_button.hide(); } else { champ_ogres_button.show(); }

        }


        if (prestige.raiders_unlocked == 0) { raiders_block.hide(); } else {
            ...
            if (raiders.active == 0) {
                ...
                button6_loot.mouseenter(function() {
                    lootInspect($(this));
                }).mouseleave(function() {
                    loot_tooltip.hide();
                    loot_tooltip.text('');
...
function insertItem(item_id) {
    ...
    if (alchemist.purse.items[0] == 42) { price *= 0.5; } else if (alchemist.purse.items[0] == 43) { price *= 0.5; } else if (alchemist.purse.items[0] == 53) { price *= 0.5; } else if (alchemist.purse.items[0] == 69) { price *= 0.1; }
    ...
    if (items[item_id][3] != 'pack of items') {
        prestige.items[item_id]++;
        rateCalc();
    }
...
function setupGandlor() {
    ...
    if (prestige.garden.tree_state == 3) {
        gandlor.tier1_src.push('win_pe');
        gandlor.tier2_src.push('win_pe');
    }
...
function gandlorLoop() {
    ...
    gandlor.spin++;
    if (gandlor.spin > 5) { gandlor.spin = 1; }
    gandlor.spin2++;
    if (gandlor.spin2 > 5) { gandlor.spin2 = 1; }

    if (gandlor.frame < 10) {
        gandlor.deuce[0] = gandlor.spin;
        gandlor.deuce[1] = gandlor.spin2;
    }
    ...
    if (gandlor.frame == 10) {
        ...
        if (gandlor.seer_deuce[0] != 0) {
            gandlor.deuce[1] = gandlor.seer_deuce[1];
            player.gandlor.seer = 0;
            gandlor.seer_deuce = [0, 0];
        }
...
function gandlorGame() {
    ...
    if (gandlor.stage == 0) {
        ...
        for (let i = 0; i < 5; i++) {
            if (gandlor.deuce[0] == gandlor.wrap[i]) {
                gandlor.class_mod[i] = '_dark';
                gandlor.deuce_class_mod[0] = '_dark';
                if (gandlor.double == 1) { gandlor.deuce_class_mod[1] = '_dark'; }
                winsum++;
            }
            if (gandlor.double == 0 && gandlor.deuce[1] == gandlor.wrap[i]) {
                gandlor.class_mod[i] = '_dark';
                gandlor.deuce_class_mod[1] = '_dark';
                winsum++;
            }
        }
        ...
        if (gandlor.double == 0 && winsum > 0 && winsum < 3 && gandlor.bet == 2) {
            playAudio(9);
            gandlor.stage = 4;
            alchemist.coins_spent -= gandlor.bet / 2;
            coins = recalcCoins();
        }
        ...
        if (winsum <= 0 && coins >= gandlor.min_bet) {
            playAudio(8);
            gandlor.stage = 4;
        } else if (winsum <= 0 && coins < gandlor.min_bet) {
            playAudio(13);
            gandlor.stage = 4;
        }
        ...
        gandlor.bonus[0] = 0;
        gandlor.bonus_class[0] = 6;
        gandlor.bonus[1] = 0;
        gandlor.bonus_class[1] = 6;
        gandlor.bonus[2] = 0;
        gandlor.bonus_class[2] = 6;
...
function fortificationInspect($button) {
    ...
    switch ($button.attr('id')) {
        case 'fort_button_weaklings':
            ...
            if (prestige.raiders_unlocked == 1) { special = '<span class="orange">Raiders unlocked</span>'; } else { special = '<i>Fortified weaklings unlocks raiders</i>'; }
        ...
        case 'fort_button_dwarves':
            ...
            if (prestige.gandlor == 1) { special = '<span class="orange">Gandlor\'s Cave unlocked</span>'; } else { special = '<i>Fortified dwarves unlock Gandlor\'s Cave</i>'; }
            if (prestige.garden.fortifications[1] >= 2) { special += '<br><br><span class="orange">Max amount of items you can win increased</span>'; } else { special += '<i><br><br>Second fortification increases the max amount of items you can win</i>'; }
            break;
        case 'fort_button_humans':
            name = fort_names[2];
            price = prestige.garden.fort_prices[2];
            level = prestige.garden.fortifications[2];
            if (prestige.museum == 1) { special = '<span class="orange">Treasury unlocked</span>'; } else { special = '<i>Second fortification unlocks Treasury</i>'; }
            break;
        case 'fort_button_ogres':
            name = fort_names[3];
            price = prestige.garden.fort_prices[3];
            level = prestige.garden.fortifications[3];
            if (prestige.cannibals == 1) { special = '<span class="orange">Cannibals unlocked</span>'; } else { special = '<i>Fortified ogres unlock cannibals</i>'; }
        ...
        case 'fort_button_wizards':
            ...
            if (prestige.hog == 1) { special = '<span class="orange">Hall of Giants unlocked</span>'; } else { special = '<i>Second fortification unlocks Hall of Giants</i>'; }
            break;
        case 'fort_button_warlocks':
            name = fort_names[5];
            price = prestige.garden.fort_prices[5];
            level = prestige.garden.fortifications[5];
            if (prestige.graveyard == 1) { special = '<span class="orange">Necropolis unlocked</span>'; } else { special = '<i>Second fortification unlocks Necropolis</i>'; }
            break;
        case 'fort_button_witches':
            name = fort_names[6];
            price = prestige.garden.fort_prices[6];
            level = prestige.garden.fortifications[6];
            if (prestige.aviary.unlocked == 1) { special += '<span class="orange">Aviary unlocked</span>'; } else { special += '<i>Second fortification unlocks Aviary</i>'; }
            break;
        case 'fort_button_wyverns':
            name = fort_names[7];
            price = prestige.garden.fort_prices[7];
            level = prestige.garden.fortifications[7];
            if (prestige.dragons_tower == 1) { special += '<span class="orange">Tower of Dragons unlocked</span>'; } else { special += '<i>Second fortification unlocks Tower of Dragons</i>'; }
            break;
...
function treeInspect() {
    ...
    if (inspect_width < 10) { inspect_width = settings.inspect_width; } else { settings.inspect_width = inspect_width; }
...
function treeSetType() {
    ...
    if (alchemist.purse.items[0] == 21) {
        alchemist.purse.items[0] = 22;
        recalcRaidTime();
        rateCalc();
        prestige.items[22] = 1;
    }
    if (alchemist.purse.items[0] == 6) {
        alchemist.purse.items[0] = 21;
        recalcRaidTime();
        rateCalc();
        prestige.items[21] = 1;
    }

    if (alchemist.purse.items[0] == 3 && prestige.garden.tree_type != 'enchanted') {
        alchemist.purse.items[0] = 6;
        recalcRaidTime();
        prestige.items[6] = 1;
...
function fortificationUpgrade(unit) {
    ...
    switch (unit) {
        case 0:
            prestige.raiders_unlocked = 1;
            prestige.alchemist_purse = 1;
            if (prestige.garden.fortifications[unit] > 1) { prestige.fort_time_mod++; }
            break;
        case 1:
            if (prestige.garden.fortifications[unit] == 1) {
                prestige.alchemist_purse = 1;
                prestige.gandlor = 1;
            }
        ...
        if (creatures_amount >= value) {
            ...
            for (let i = 0; i < alchemist_creatures_array.length; i++) {
                ...
                if (alchemist_creatures_array[i] == 0 && creatures_amount >= strangeUpgrades_creatures_array[i][0]) {
                    ...
                    let price = 0;
                    if (strangeUpgrades_creatures_array[i][4] == 0) { price = tower1.current_rate_max * 1000; } else { price = strangeUpgrades_creatures_array[i][4]; }
...
function alchemistUpgrade(id, ui = true) {
    ...
    if (upgrade_type == 24 && alchemist.purse.items[0] == 53 && items[upgrade_id][4] == 'equippable item' && getRandomInt(1, 3) != 2) {
        ...
        if (ui == true) {
            ...
            if (misc_settings.gandlor_display == 1) {
                recalcCoins();
                gandlorUI();
            }
    ...
    switch (upgrade_type) {
        ...
        case 1:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.weaklings_multiplier *= 2;
        ...
        case 10:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.medallions_multiplier += 0.05;
        ...
        case 17:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.warlocks_strange_upgrades += 0.1;
                break;
        ...
        case 18:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.witches_strange_upgrades += 0.01;
                break;
        ...
        case 19:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.wyverns_strange_upgrades += 0.001;
                break;
        ...
        case 21:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.crossbows_strange_upgrades += 0.1;
                break;
        ...
        case 22:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.cheiroballistras_strange_upgrades += 0.01;
                break;
        ...
        case 24: //ITEMS
            ...
            switch (upgrade_id) {
                ...
                case 2:
                    if (prestige.garden.tree_state == 3) { prestige.garden.tree_age += 900; } else { prestige.garden.tree_age += 600; }
                    break;

                case 3:
                    if (alchemist.purse.items[0] == 6) {
                        prestige.garden.tree_age += 600;
                        recalcRaidTime();
                    } else if (alchemist.purse.items[0] == 21) {
                        prestige.garden.tree_age += 1500;
                        recalcRaidTime();
                    } else {
                ...
                case 16:
                    if (prestige.unlocked_locations.horium == 0) {
                        ...
                        if (prestige.raiders_locations[raiders.locations_pointer] == 2) { raiders.counter -= 900; } else { raiders.counter -= 600; }
                    }
        ...
        case 25:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.snail_reward_modifier *= 2;
                break;
        ...
        case 26:
            ...
            switch (upgrade_id) {
                ...
                default: alchemist.cannibals_multiplier *= 2;
        ...
        case 27:
            ...
            switch (upgrade_id) {
                default: alchemist.dragons_factor[0]++;
        ...
        case 28:
            ...
            switch (upgrade_id) {
                default: alchemist.dragons_factor[1]++;
                recalculateFireMultiplier();
                break;
            }
            break;
        ...
        case 29:
            ...
            switch (upgrade_id) {
                default: alchemist.dragons_factor[2]++;
                recalculateFireMultiplier();
                break;
            }
            break;
        ...
        case 30:
            ...
            switch (upgrade_id) {
                default: alchemist.dragons_factor[3]++;
                recalculateFireMultiplier();
                break;
            }
            break;
        ...
        case 31:
            ...
            switch (upgrade_id) {
                default: alchemist.dragons_factor[4]++;
                recalculateFireMultiplier();
                break;
            }
            break;
...
function recipeEval() {
    ...
    //stop potency from overshooting into the next bucket
    if (non_primary_mix > 50) {
        alchemist.flask.error[0] = 1;
    ...
    if (alchemist.flask.error[0] + alchemist.flask.error[1] + alchemist.flask.error[2] > 0) {
        alchemist.flask.result = 99999;
        alchemist.flask.confirm = 0;
        return;
    }
...
function ingredientsUI() {
    ...
    all_ingredients.mouseenter(function() {
        ingredientInspect($(this));
...
function flaskUI() {
    ...
    if (alchemist.flask.tab == 0) { flask_tab_flask.attr("class", "button8_tabs"); } else { flask_tab_flask.attr("class", "button8_tabs_inactive"); }
    if (alchemist.flask.tab == 1) { flask_tab_ingredients.attr("class", "button8_tabs"); } else { flask_tab_ingredients.attr("class", "button8_tabs_inactive"); }
    if (alchemist.flask.tab == 2) { flask_tab_recipes.attr("class", "button8_tabs"); } else { flask_tab_recipes.attr("class", "button8_tabs_inactive"); }
    ...
    if (alchemist.flask.tab == 0) {
        ...
        if (alchemist.flask.result == 99999) {
            ...
            if (alchemist.flask.confirm == 0) { flask_confirm_block.hide(); } else { flask_confirm_block.show(); }
        ...
        all_recipe_buttons.mouseenter(function() {
            ingredientInspect($(this));
        }).mouseleave(function() {
            ingredient_tooltip.hide();
            ingredient_tooltip.text('');
        });
...
function recalculateMessengersTime() {
    ...
    if (alchemist.messengers_arrival_modifier == 1) { messenger.missesThreshold = 15; } else if (alchemist.messengers_arrival_modifier == 0.5) { messenger.missesThreshold = 20; } else if (alchemist.messengers_arrival_modifier == 0.25) { messenger.missesThreshold = 30; }
}
    ...
    switch (raiders.locations_index) {
        ...
        case 1: //ancient pyramid
            ...
            switch (raiders.locations_runs[1]) {
                ...
                case 8:
                    if (prestige.gandlor == 1) { raiders.loot = [8, 20, 24, 23]; } else { raiders.loot = [8, 20, 24, 28]; }
                    break;
...
function refreshUIHoG() {
    ...
    if (hog.all_diamonds >= 72) { hog_buymax.hide(); } else {
        hog_buymax.show();

        if (tower1.counter >= hog.diamonds_price[hog.buy_amount_index]) { hog_buymax.prop('disabled', false); } else { hog_buymax.prop('disabled', true); }
    ...
    if (prestige.museum == 1) {
        ...
        museum_multiplier_label.html('<br><div class="gandlorpink">Treasury Factor: <b>+' + Math.floor(m_multiplier) + '%</b></div>');
...
function refreshUIGraveyard() {
    ...
    if (graveyard.succubi < 50) {
        necropolis2_block.hide();
        necropolis2_lock.show();
    } else {
        necropolis2_block.show();
        necropolis2_lock.hide();
    ...
    if (graveyard.grandliches < 50) {
        necropolis3_block.hide();

        if (graveyard.succubi >= 50) { necropolis3_lock.show(); } else { necropolis3_lock.hide(); }

    } else {
        necropolis3_block.show();
        necropolis3_lock.hide();
...
function necromancerUI() {
    ...
    all_necromancer_upgrades.mouseenter(function() {
        necromancerInspect(parseInt($(this).attr('id').slice(1)));
    }).mouseleave(function() {
        necromancer_tooltip.hide();
        necromancer_tooltip.text('');
    });
    all_necromancer_upgrades_disabled.mouseenter(function() {
        necromancerInspect(parseInt($(this).attr('id').slice(1)));
    }).mouseleave(function() {
        necromancer_tooltip.hide();
        necromancer_tooltip.text('');
        ...
        if (creatures_amount >= value) {
            ...
            for (let i = 0; i < necromancer_creatures_array.length; i++) {
                ...
                if (necromancer_creatures_array[i] == 0 && creatures_amount >= hauntedUpgrades_creatures_array[i][0]) {
                    ...
                    let price = 0;
                    if (hauntedUpgrades_creatures_array[i][4] == 0) { price = graveyard.rate * 1000; } else { price = hauntedUpgrades_creatures_array[i][4]; }
    ...
    switch (upgrade_type) {
        ...
        case 1:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.skeletons_factor += 0.1;
                break;
        ...
        case 2:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.spirits_factor += 0.1;
                break;
        ...
        case 3:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.specters_factor += 0.1;
                break;
        ...
        case 4:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.succubi_factor += 1;
                break;
        ...
        case 5:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.ghouls_factor += 1;
                break;
        ...
        case 6:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.ghasts_factor += 0.1;
                break;
        ...
        case 7:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.grimlords_factor += 0.1;
                break;
        ...
        case 8:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.grandliches_factor += 1;
                break;
        ...
        case 9:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.areds_factor += 1;
                break;
        ...
        case 10:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.ardemators_factor += 0.1;
                break;
        ...
        case 11:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.archsentinels_factor += 0.1;
                break;
        ...
        case 12:
            ...
            switch (upgrade_id) {
                ...
                default: necromancer.andlyns_factor += 1;
                break;
...
function isLibraryUpgradeSold(tome = 8, upgrade_id) {
    ...
    switch (tome) {
        ...
        case 1:
            if (prestige.library.tome_weaklings[upgrade_id] == 1) { return true; } else { return false; }

        case 2:
            if (prestige.library.tome_dwarves[upgrade_id] == 1) { return true; } else { return false; }

        case 3:
            if (prestige.library.tome_darkarts[upgrade_id] == 1) { return true; } else { return false; }

        case 4:
            if (prestige.library.tome_inventions[upgrade_id] == 1) { return true; } else { return false; }

        case 5:
            if (prestige.library.tome_timedivinations[upgrade_id] == 1) { return true; } else { return false; }

        case 6:
            if (prestige.library.tome_alcohol[upgrade_id] == 1) { return true; } else { return false; }

        case 7:
            if (prestige.library.tome_alchemy[upgrade_id] == 1) { return true; } else { return false; }

        case 8:
            if (prestige.library.tome_intro[upgrade_id] == 1) { return true; } else { return false; }

        case 9:
            if (prestige.library.tome_dead[upgrade_id] == 1) { return true; } else { return false; }

        case 10:
            if (prestige.library.tome_fortress[upgrade_id] == 1) { return true; } else { return false; }
...
function isTomeRead(id) {
    ...
    if (count_upgrades == tome.items.length) { return true; } else { return false; }
...
function libraryUpgrade(id) {
    ...
    if (prestige.library.tome_selected_id == 1) {
        ...
        switch (id) {
            ...
            case 0:
                prestige.alchemist_packages.warlocks2 = 1;
                break;

            case 1:
                prestige.alchemist_packages.witches2 = 1;
                break;

            case 2:
                prestige.alchemist_packages.wyverns2 = 1;
                break;
        ...
        switch (id) {
            ...
            case 0:
                prestige.alchemist_packages.catapults2 = 1;
                break;

            case 1:
                prestige.alchemist_packages.crossbows2 = 1;
                break;

            case 2:
                prestige.alchemist_packages.cheiroballistras2 = 1;
                break;
        ...
        switch (id) {
            ...
            case 0:
                prestige.offline += 0.05;
                break;

            default:
                prestige.offline += 0.1;
                break;
        ...
        switch (id) {
            ...
            case 0:
                prestige.alchemy_lock = 1;
                break;

            case 1:
                prestige.flask_unlocked = 1;
                break;

            case 2:
                prestige.alchemy_persistence = 1;
                break;
...
function loadGame() {
    ...
    if (settings.dwarf_hammers_warning == 0) {
        setTimeout(function() {
            notificationMachen('dwarf_hammers_warning');
            refreshUI();
        }, 500);
    }
...
function riotsCompleted() {
    ...
    if (prestige.champs.unlocked[0] + prestige.champs.unlocked[1] + prestige.champs.unlocked[2] + prestige.champs.unlocked[3] == 4 || tower1.discontent.riot == 2) { return true; } else { return false; }
...
function guideAlertCheck() {
    ...
    if (check < Object.keys(player.guide).length) { return true; } else { return false; }
}
...
function numT(number, decPlaces = 2) {
    ...
    if (settings.scientific == 0) {
        ...
        if (number >= 1000) { return Number(number).toExponential(2).replace(/\+/g, ""); } else { number = Math.round(number * 100) / 100; }
    }
...
function numT2(number) {
    if (number > 1000) { return Number(number).toExponential(3); } else { number = Math.round(number * 1000) / 1000; }
    return number;
}
...
function nM() { //mana
    ...
    if (prestige.all_time_counter >= nextManaCost) {
        ...
        if (prestige.multiplier > 1) { rmana_label.text(numT(rmana - prestige.multiplier)); } else { rmana_label.text(numT(rmana)); }
...
function nS() { //souls
    ...
    if (prestige.all_time_graveyard_counter >= nextSoulsCost) {
        ...
        if (prestige.souls_multiplier > 1) { rsouls_label.html('Souls captured: <b>' + numT(rsouls - prestige.souls_multiplier) + '</b>'); } else { rsouls_label.html('Souls captured: <b>' + numT(rsouls) + '</b>'); }
    ...
    if (settings.audio_mute == 0) {
        switch (snd) {
            case 1:
                ...
                break;
            case 2:
                audio.hammer.rate(getRandomInt(1.5, 4));
                audio.hammer.play();
                break;
            case 3:
                audio.hammer2.play();
                break;
            case 4:
                audio.alchemist_click.play();
                break;
            case 5:
                audio.select_click.play();
                break;
            case 6:
                audio.hammer.rate(2);
                audio.hammer.play();
                break;
            case 7:
                audio.gandlor_pick.play();
                break;
            case 8:
                audio.gandlor_lose.play();
                break;
            case 9:
                audio.gandlor_win.play();
                break;
            case 10:
                audio.gandlor_spin.play();
                break;
            case 11:
                audio.gandlor_shuffle.play();
                break;
            case 12:
                audio.gandlor_win2.play();
                break;
            case 13:
                audio.gandlor_gameover.play();
                break;
            case 14:
                audio.gandlor_powerup.play();
                break;
            case 15:
                audio.gandlor_double.play();
                break;
            case 16:
                audio.gandlor_single.play();
                break;
            case 17:
                audio.thunder.play();
                break;
